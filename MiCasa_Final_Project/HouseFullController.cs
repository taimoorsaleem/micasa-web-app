...
{
    public class HouseFullController : ApiController
    {
        [Route("api/house_full")]
        public IEnumerable<MobileItem> Get()
        {
            MobileItem[] m;
            List<MobileItem> ml = new List<MobileItem>();

            DataTable dt = DataLink.PropertyData.GetHouseFullMobile();
