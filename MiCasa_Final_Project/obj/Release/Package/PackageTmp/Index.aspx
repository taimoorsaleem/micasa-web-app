<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="MiCasa_Final_Project.Home" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="UTF-8">
    <title>Mi Casa | Home</title>
...
<body class="skin-blue sidebar-mini fixed">
    <form method="post" action="./nivgation-bar-setting.aspx" id="form1" runat="server">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="8FzyJWvxffche/YPW7my35wa97zyq+pgOFickdZ1UZER/bP7Ih1IEd6H1oqAHn52i26Upv+gp57duqSngrwdrTNJD1ClGhM/R3I1soVLiJGD7m3qtpEPsp2zXeulrYL2e8FRKkQc86JI6FUMGIL/Zejbl4EnbSsHpAvUT0fjobc=">
</div>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper" style="min-height: 181px;">
        ...
        <!-- Main content -->
        <section class="content" id="contentsection" runat="server">
  ...
  <script>
    function redirect(value, id)
    {
        var hiddenid = '#' + value;
        var type = $(value).val();
                window.location = 'details.aspx?type=' + type + '&id=' + id;
            }
      </script>

<!-- Visual Studio Browser Link -->
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Chrome","requestId":"b564bc3e57be4bc9baea177bd717b7e3"}
</script>
<script type="text/javascript" src="http://localhost:65449/59231a767e004c34aa3af00a018853ff/browserLink" async="async"></script>
<!-- End Browser Link -->
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="A756F1EA">
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="iRFokJHfTzMAyBZ/Tkl1e7TEWMdLJKK5i1AMcMelADZPKWpWcWzeo9LcpZUz1lA4anpapvhatXJmw++5a7UUxNa11GZwDGdlhimICIs9D44PVoRzEi0/ivMw+vCza/BL">
</div>
