<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="MiCasa_Final_Project.searchResult" %>
...
<head>
    ...
    <title>Mi Casa | Search Result</title>
...
<body class="skin-blue sidebar-mini fixed">
    <form runat="server">
    <!-- Site wrapper -->
    <form method="post" action="./searchResult.aspx" id="ctl00">
        <div class="aspNetHidden">
            <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="zT7JSzLkMV6LZu90xtfc/rBBtrVwkl73NJo0UaCg8mPMf2rgq5ovgUzMCFZRrTwwLafcYLDoR5KbCNWA2BJ99Wj+DLcZVMSZOTLUjKuAw+Y=">
        </div>
...
<li id="registerlink" runat="server">
        ...
        <!-- /.sidebar -->
            ...
            <div class="content-wrapper" style="min-height: 1741px;">
                ...
                <!-- Main content -->
                <section class="content" runat="server" id="content">
    ...
    <div class="aspNetHidden">
        ...
        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="hH47H9QRXnfKiK8CNvMxas1ihlXFSBu+va4RkrBA1Gcn2ToBFflJJDBEeeJ93MCmvrxhRYIxMl+90HuhrH47/tY46soC3ulABO10I5JyrlEQR3Rd+6CM50AhSIR+KwCu">
    </div>
    <!-- jQuery 2.1.4 -->
    ...
    <script type="application/json" id="__browserLink_initializationData">
        {"appName":"Chrome","requestId":"22356a771ca1434ea082a581e8c093d8"}
    </script>
    <script type="text/javascript" src="http://localhost:51558/f3cc4038b40549a0868eac013a74e086/browserLink" async="async"></script>
        <script type="text/javascript">
            //function f(){
            //    window.location = 'details.aspx?id=2';
            //}

            function details_plot(value)
            {
                window.location = 'details.aspx?type=plot&id=' + value;
            }
            
            function details_appartment(value) {
                window.location = 'details.aspx?type=appartment&id=' + value;
            }

            function details_house_full(value) {
                window.location = 'details.aspx?type=house_full&id=' + value;
            }

            function details_house_portion(value) {
                window.location = 'details.aspx?type=house_portion&id=' + value;
            }
        </script>
    <!-- End Browser Link -->
