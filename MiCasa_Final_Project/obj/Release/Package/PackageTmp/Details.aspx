<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="MiCasa_Final_Project.add_detail" %>
...
<head runat="server">
      ...
      <meta charset="UTF-8">
    <title>Mi Casa | Ad Details</title>
...
<li id="registerlink" runat="server">
      ...
      <div class="content-wrapper" style="min-height: 2635px;">
...
<div class="pull-right btn-box-tool" style="width:25%;margin-top:0.5%">

              <!-- Profile Image -->
              <div class="box box-primary">
                <div class="box-body box-profile">
                  <img class="profile-user-img img-responsive img-circle" src="../../dist/img/profile-img.jpg" alt="User profile picture" id="UserImage" runat="server">
                  <h3 class="profile-username text-center"><asp:Label ID="lblUName" runat="server" Text="Taimoor Saleem"></asp:Label></h3>
                  

                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Contact Number</b> <a class="pull-right"><asp:Label ID="lblUserNumber" runat="server" Text="03138962357"></asp:Label></a>
                    </li>
                    <li class="list-group-item">
                      <b>Email</b> <a class="pull-right"><asp:Label ID="lblUserEmail" runat="server" Text="taimoorsalim@gmail.com"></asp:Label></a>
                    </li>
                    <li class="list-group-item">
                      <b>Location</b> <a class="pull-right"><asp:Label ID="lblUserLocation" runat="server" Text="Karachi"></asp:Label></a>
                    </li>
                  </ul>
...
<div class="box box-primary">
                <div class="box-body box-profile" id="PropertyBox" runat="server">
               
                  <h3 class="profile-username text-center"><asp:Label ID="lblPropertyTitle" runat="server" Text="Property Name"></asp:Label></h3>
                    <h3 class="profile-username text-center"><asp:Label ID="lblPropertyMode" runat="server" Text="For Sell"></asp:Label></h3>
                  

                  <ul class="list-group list-group-unbordered" id="AdDetails" runat="server">
                 
                         <li class="list-group-item">
                      <b>Category</b> <a class="pull-right"><asp:Label ID="lblPropertyType" runat="server" Text="Banglow"></asp:Label></a>
                    </li>
                         <li class="list-group-item">
                      <b>Area</b> <a class="pull-right"><asp:Label ID="lblPropertArea" runat="server" Text="Gulshan-e-Mustafa"></asp:Label></a>
                    </li>
                    
                 
                      <li class="list-group-item">
                      <b>Size</b> <a class="pull-right"><asp:Label ID="lblPropertyUnitSize" runat="server" Text="3 Marla"></asp:Label></a>
                    </li>
                      <li class="list-group-item">
                      <b>Price</b> <a class="pull-right"><asp:Label ID="lblPropertyPrice" runat="server" Text="Rs.555500/-"></asp:Label></a>
                    </li>
                  </ul>
                      ...
                      <div class="col-md-9" style="width:75%;margin-top:1%;">
              <div class="post">
                      <!-- /.user-block -->
              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators" id="counter" runat="server">
                      <%--<li data-target="#carousel-example-generic" data-slide-to="0" class=""></li>
                      <li data-target="#carousel-example-generic" data-slide-to="1" class=""></li>
                      <li data-target="#carousel-example-generic" data-slide-to="2" class="active"></li>--%>
                    </ol>
                    <div class="carousel-inner" id="imagecontainer" runat="server" style=" height:400px">
...
<textarea class="form-control input-sm" placeholder="Description" style="width:100%;height:200px;resize:none;margin-top:0.5%;" disabled="true" id="txtdesc" runat="server"></textarea>                      
  </div>
